...
const Sliders = (props) => {
  console.log('props',props.title);
    const [images, setimages] = useState(['https://jobipo.com/uploads/slider/1666088609-0e3673fb-047c-b08b-49d2-e397906a2a84.png'])
    ...
    const GetDataFunc = async () => {
      ...
      if (sliderDataApi) { 
        if (sliderDataApi.logout != 1) {
          ...
          setimages(JSON.parse(JSON.parse(JSON.stringify(sliderDataApi)).msg).slider);
            ...
            contentContainerStyle={{
             ...
             <View style={style.container}> 
                  <ScrollView
                    ...
                    horizontal
                    onScroll={ () => { 
                      if(images.length > 0){  this.change; }
                     }}
