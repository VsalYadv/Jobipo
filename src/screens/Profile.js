  ...
  const UpdateData = async () => {
    ...
    try {
      ...
      const asd = await fetch(
        'https://jobipo.com/api/Agent/dochngprofile',
        {
          method: 'POST',
          headers: {
    ...
    const GetDataFunc = async () => {
      ...
      if (sliderDataApi) {
        if (sliderDataApi.logout != 1) {
          ...
          setfullName(JSON.parse(JSON.parse(JSON.stringify(sliderDataApi)).msg).users.fullName);
          setaddress(JSON.parse(JSON.parse(JSON.stringify(sliderDataApi)).msg).users.address);
          setDOB(JSON.parse(JSON.parse(JSON.stringify(sliderDataApi)).msg).users.DOB);
          console.log(JSON.parse(JSON.parse(JSON.stringify(sliderDataApi)).msg).users.Pic)
          if (JSON.parse(JSON.parse(JSON.stringify(sliderDataApi)).msg).users.Pic != "") {
            console.log('conrent jfjf');
            SetPic(JSON.parse(JSON.parse(JSON.stringify(sliderDataApi)).msg).users.Pic);
          }
        } else {
    ...
    const loadSavedProfileImage = async () => {
      try {
        ...
        if (savedImage) {
          ...
          console.log('Profile image loaded in Profile from AsyncStorage');
        }
      } catch (error) {
        console.log('Error loading profile image in Profile:', error);
      }
    };
          ...
          <View style={styles.centerContent}>
            <TouchableHighlight onPress={() => uploadImage()}
              ...
              <View style={styles.button}>
                <Avatar.Image
                  size={130}
                  source={savedProfileImage ? { uri: savedProfileImage.uri } : { uri: 'data:image/png;base64,' + Pic }}
                />
              </View>
            </TouchableHighlight>
          </View>
          ...
          <View style={[styles.product]}>
            <View style={[styles.bigWith]}>
              <View style={[styles.inputRow, isEditing && styles.editRow]}>
                <FontAwesome name="user" size={30} color="#0d4574" style={styles.icon} />
                <TextInput
              ...
              <View style={[styles.inputRow, isEditing && styles.editRow]}>
                <FontAwesome name="calendar" size={20} color="#0d4574" style={styles.icon} />
                <Pressable
              ...
              <View style={[styles.inputRow, isEditing && styles.editRow]}>
                <FontAwesome name="map-marker" size={20} color="#0d4574" style={styles.icon} />
                <TextInput
                  placeholder="Address"
                  value={address}
              ...
              <View style={[styles.inputRow, isEditing && styles.editRow]}>
                <FontAwesome name="location-arrow" size={20} color="#0d4574" style={styles.icon} />
                <TextInput
                  placeholder="Pincode"
                  value={pincode}
              ...
              <View style={[styles.inputRow, isEditing && styles.editRow]}>
                <FontAwesome name="briefcase" size={20} color="#0d4574" style={styles.icon} />
                <TextInput
              ...
              <View style={[styles.inputRow, isEditing && styles.editRow]}>
                <FontAwesome name="graduation-cap" size={20} color="#0d4574" style={styles.icon} />
                <TextInput
              ...
              <View style={styles.buttonRow}>
                ...
                <Pressable onPress={SaveData} style={styles.saveButton} disabled={!isEditing}>
