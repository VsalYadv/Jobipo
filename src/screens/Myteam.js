      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.MainContainer}>
          ...
          <View style={[styles.product, styles.BackgroundYellow]}>
            <View style={[styles.bigWith]}>
              <Text style={styles.title}>{totalEarning.count} in your team</Text>
            </View>
            <View style={styles.productDescBox}>
              <Text style={styles.title}>₹ {totalEarning.totalEarning ? totalEarning.totalEarning : 0}</Text>
            </View>
            <View style={styles.productDescBox}>
              <Text style={styles.title}>₹ {totalEarning.totalEarning ? totalEarning.totalEarning / 10 : 0}</Text>
            </View>
          </View>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={[styles.product, styles.BackgroundWhite, styles.marginTop10]}>
                <View style={[styles.bigWith]}>
                  <Text style={styles.Datatitle}>{item.fullName}</Text>
                  <Text style={styles.Datadesc}>Contact : {item.contactNumber1}</Text>
                  <Text style={styles.Datadesc}>Refer Code : {item.uniqueCode}</Text>
                </View>
                <View style={styles.productDescBox}>
                  <Text style={styles.Datatitle}>₹ {item.AmountEarn ? item.AmountEarn : 0}</Text>
                </View>
                <View style={styles.productDescBox}>
                  <Text style={styles.Datatitle}>₹ {item.AmountEarn ? item.AmountEarn / 10 : 0}</Text>
                </View>
              </View>
            )}
            horizontal={false}
