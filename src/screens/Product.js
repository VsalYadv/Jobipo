...
const Product = ({ navigation, route }) => {
  ...
  const products = [
    ...
    },
    {
      ...
      content: 'Refer and Earn Rs. 250/- Each Successful Kotak 811 Saving Account Opened',
      desc: 'Earn Up to Rs. 1450/-',
    },
    {
      id: 2,
    ...
    <>
      ...
      <ScrollView>
        <View style={styles.container}>
          <View style={[styles.product]}>
            ...
            <View style={styles.cardContainer}>
              <Pressable
                ...
                style={styles.card}>
                <Text style={styles.cardText}><FontAwesome name="copy" color="#fff" /> Copy Link</Text>
              </Pressable>
              <Pressable
                onPress={() => onShare()}
                style={styles.card}>
                <Text style={styles.cardText}><FontAwesome name="share" color="#fff" /> Share</Text>
              </Pressable>
            </View>
          </View>
          ...
          <View style={styles.optionsBox}>
            ...
            >
              ...
              <Pressable
                ...
                (ActiveDiv == 4) ? {
                  color: '#0d4574',
                } : {}]}>Sharing Materials</Text>
              </Pressable>
            </ScrollView>
          </View>
          <View style={[styles.product, styles.productDetails,
          (ActiveDiv != 1) ? {
            display: 'none'
          } : {}]}>
            <View style={styles.productDescBox}>
          ...
          <View style={[styles.product, styles.termsandCondition,
          (ActiveDiv != 2) ? {
            display: 'none'
          } : {}]}>
            <View style={styles.productDescBox}>
          ...
          (ActiveDiv != 4) ? {
            ...
            <View style={styles.productDescBox}>
              <View
                style={[{ borderColor: '#000', borderRadius: 5, borderWidth: 1, textAlign: 'center', justifyContent: 'center', width: 200, }]}
              >
                <Image
                  source={{ uri: brandsData['image'] }}
                  style={[styles.cardDI]}
                  resizeMode="contain"
                />
                <Text style={[styles.cardDText]}>{brandsData['titlesmaterial1']}</Text>

                <Pressable
                  onPress={() => {
                    Linking.openURL(`https://jobipo.com/uploads/product/dn.php?path=` + brandsData['smaterial1']);
                    alert("Link Copied.");
                  }}
                  style={styles.cardD}>
                  <Text style={styles.cardText}><FontAwesome name="download" color="#fff" /> Download</Text>
                </Pressable>
              </View>
            </View>
          </View>
