...
import { View, Text, TouchableOpacity, FlatList,ActivityIndicator, StyleSheet, Alert, Pressable } from 'react-native';
...
const AppliedJobPage = ({ navigation }) => {
  ...
  const renderJobItem = ({ item }) => (
    <Pressable style={styles.jobBox} onPress={() => {
      ...
      <View style={styles.statusContainer}>
        <View style={{
          ...
          backgroundColor: applicationStatus[Number(item.applicationStatus) - 1].style.backgroundColor
        }}>
          <Text style={[styles.statusText, {
            color: applicationStatus[Number(item.applicationStatus) - 1].style.color,
            backgroundColor: applicationStatus[Number(item.applicationStatus) - 1].style.backgroundColor,
          }]}>
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        {isLoading ? (
          <ActivityIndicator size="large" color="#0d4574" style={{ marginTop: 50 }} />
        ) : (
          <FlatList
            data={appliedJobs}
