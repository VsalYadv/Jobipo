...
import { View, Text, Image, ScrollView, StyleSheet, Modal, Button, TextInput, TouchableOpacity, FlatList, Alert } from 'react-native';
            ...
            <View style={styles.profileHeader}>
              ...
              <View style={styles.profileTextContainer}>
                ...
                <View style={styles.profileRow}>
                  <Icon name="briefcase-outline" size={16} color="#555" style={styles.profileIcon} />
    ...
    <View style={styles.row}>
      ...
      <Text style={styles.text}>{users.emailID}</Text>
          ...
          <View style={[styles.ExperienceSection, {
            ...
            <View style={styles.infoValue}>
              <TouchableOpacity style={styles.addButton} onPress={() => navigation.navigate('EditJobDetails', { jobSeekerData, data: null })} >
                ...
                <View style={styles.card}>
                  <View style={styles.cardHeader}>
                    ...
                    <View style={styles.jobDetails}>
                      <Text style={styles.jobTitle}>{item?.preferred_job_Title}</Text>
                      <Text style={styles.companyName}>{item?.preferred_job_industry}</Text>
                      <Text style={styles.companyName}>{item?.workMode}</Text>
                    </View>
                    <TouchableOpacity onPress={() => navigation.navigate('EditJobDetails', { jobSeekerData, data: item, index })}>
          ...
          <View style={styles.sectionContainer}>
            <View style={styles.ExperienceSection}>
              ...
              <View style={styles.infoValue}>
                <TouchableOpacity style={styles.addButton} onPress={() => navigation.navigate('AddLanguage', jobSeekerData)} >
            ...
            <Text style={styles.skillsText}>
              {Array.isArray(parseIfArrayString(jobSeekerData?.languageKnown)) ? parseIfArrayString(jobSeekerData?.languageKnown).join(', ') : 'No languages added yet.'}
            </Text>
          </View>
              ...
              return (
                <View style={styles.card}>
                  <View style={styles.cardHeader}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('EditEducation', { jobSeekerData, data: item, index })}>
                      <IconA name="edit" size={20} color="#2d8659" />
                    </TouchableOpacity>
                  </View>
                  <View style={styles.section}>
                    <Text style={styles.sectionValue}>{item?.educationLevel}</Text>
                  </View>
                  {/* <View style={styles.dateContainer}>
              ...
              return (
                <View style={styles.card}>
                  <View style={styles.cardHeader}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('EditExperience', { jobSeekerData, data: item, index })}>
                      <IconA name="edit" size={20} color="#2d8659" />
                    </TouchableOpacity>
                  </View>
