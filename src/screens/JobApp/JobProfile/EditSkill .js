    ...
    try {
      ...
      if (sliderDataApi.logout !== 1) {
        if (!sliderDataApi.msg) {
          console.warn('sliderDataApi.msg missing');
        ...
        console.log('Jobseeker:', jobSeekerData);

        if (jobSeekerData?.skills) {
          console.log('Raw skills:', jobSeekerData.skills);
        ...
        console.warn('Logout triggered from server');
        signOut();
      }
    } catch (error) {
