            ...
            <View style={styles.buttonGroup}>
              {['Full-time', 'Part-time'].map((level) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.button,
                    formData.preferredEmployementType === level && styles.buttonSelected,
                  ]}
                  onPress={() => handleChange('preferredEmployementType', level)}
                >
                  <Text
                    style={[
                      styles.buttonText,
                      formData.preferredEmployementType === level && styles.buttonTextSelected,
                    ]}
                  >
                    {level}
                  </Text>
   ...
   <View style={styles.jobDetails}>
            ...
            {['0-1','1-2', '2-3','3-5','5-7','7-10'].map((option) => (
              <TouchableOpacity
                ...
                style={[
                  styles.button,
                  formData.totalExperience === option && styles.buttonSelected,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.buttonText,
                    formData.totalExperience === option && styles.buttonTextSelected,
                  ]}
                >
                  {option} Year
                </Text>
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                onValueChange={(itemValue) => handleChange('preferredJobIndustry', itemValue)}
