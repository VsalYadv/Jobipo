...
// };
 ...
 const updatedEducationData = index !== null
    ? d.map((item, id) =>
        id === Number(index)
          ? { ...formData, skills: JSON.stringify(selectedSkills) }  // ✅ inject selected skills
          : item
      )
    : [...d, { ...formData, skills: JSON.stringify(selectedSkills) }]; // ✅ for new entry
...
const styles = StyleSheet.create({
  ...
  label: {
    fontSize: 15, color: "#535353", fontWeight: "500",
    marginTop: 14,
    marginBottom: 4,
  },
  pickerContainer: {
