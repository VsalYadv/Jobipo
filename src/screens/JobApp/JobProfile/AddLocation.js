...
const AddLocation = ({ navigation, route }) => {
  ...
  const handleAddPreferredLocation = () => {
    ...
    if (
      ...
      setFormData((prevData) => ({
        ...prevData,
        preferredLocations: [...prevData.preferredLocations, newPreferredLocation.trim()],
      }));
  ...
  const handleRemovePreferredLocation = (index) => {
    const updatedPreferredLocations = formData.preferredLocations.filter((_, i) => i !== index);
    setFormData((prevData) => ({
      ...prevData,
  ...
  const handleSubmit = async () => {
    await fetch(`https://jobipo.com/api/Agent/doupdatejobp`, {
      ...
      if (res) {
        navigation.goBack()
        Alert.alert('Location Details Updated Successfully')
      }
    }).catch(err => {
    ...
    <>
      ...
      <ScrollView style={styles.scrollContainer}>
        <View style={styles.container}>
          ...
          <Text style={styles.subhead}>Jobs are shown based on your preferred city</Text>
          ...
          <Text style={styles.subhead}>Hometown is the city/village that you are from</Text>
          ...
          <View style={styles.ContainerDetails}>
            ...
            <TextInput
              ...
              onChangeText={(value) => setFormData({ ...formData, hometownLocation: value })}
            />
          </View>
        </View>
      </ScrollView>
