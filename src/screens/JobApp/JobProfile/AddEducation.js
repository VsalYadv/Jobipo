        ...
        <View style={styles.radioGroup}>
          {["Full-time", "Part-time", "Correspondence"].map((type) => (
            <View key={type} style={styles.radioOption}>
              <RadioButton value={type}  color="#0d4574"  uncheckedColor="#0d4574" />
              <Text>{type}</Text>
            </View>
          ))}
        </View>
...
const styles = StyleSheet.create({
  ...
  labelPiker: { fontSize: 14,color: "#000" , fontWeight: "600", marginTop: 15 ,marginBottom:1,},
  label: { fontSize: 14,color: "#000" , fontWeight: "600", marginTop: 23 ,marginBottom:8,},
