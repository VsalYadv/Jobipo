          ...
          <View style={styles.buttonGroup}>
            {['0-1','1-2', '2-3','3-5','5-7','7-10'].map((option) => (
              <TouchableOpacity
                ...
                style={[
                  styles.button,
                  formData.experienceLevel === option && styles.buttonSelected,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.buttonText,
                    formData.experienceLevel === option && styles.buttonTextSelected,
                  ]}
                >
                  {option} Year
                </Text>
            ...
            {["Full-time", "Part-time", "Internship"].map((level) => (
              ...
              >
                <Text
                  style={[
                    styles.buttonText,
                    formData.employmentType === level && styles.buttonTextSelected,
                  ]}
                >
                  {level}
                </Text>
...
const styles = StyleSheet.create({
  ...
  saveButton: { marginVertical: 20, backgroundColor: "#0c6951" , borderRadius: 10,
  },
  saveButtonText:{ fontSize: 20,color: "#fff" ,textAlign:'center',
    padding: 8,
  },
  jobDetails:{
...
paddingHorizontal:10,
  ...
  label: { fontSize: 14,color: "#000" , fontWeight: "600", marginTop: 14 ,marginBottom:4,},
