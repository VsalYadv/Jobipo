...
const Trainings = ({ navigation }) => {
  ...
  const GetDataFunc = async (ttrainingType) => {
    ...
    const sliderDataApi = await fetch(
      'https://jobipo.com/api/Agent/training',
      {
        method: 'POST',
        headers: {
            ...
            <Pressable
              ...
              <View style={styles.productDescBox}>
                ...
                <Pressable
                  ...
                  style={styles.card}>
                  <Text style={styles.cardText}><FontAwesome name="play-circle" style={styles.cardIcon} color="#0d4574" /> Watch Now</Text>
                </Pressable>
              </View>
            </Pressable>
          )}
