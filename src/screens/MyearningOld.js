        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.MainContainer}>
                <View style={[styles.product]}>
                    <View style={[styles.bigWith]}>
                        <Text style={[styles.Datatitle, styles.DataTitleBig]}>₹ {totalEarning}/-</Text>
                        <Text style={styles.DataSmall}>₹ {paidEarning} + ₹ { totalEarning- paidEarning} Pending</Text>
                    </View>               
                    <View style={styles.productDescBox}>
                        <Pressable 
                            ...
                            <Text  color="#535353"><FontAwesome name="filter" size={20} color="#535353" /> Filter</Text>
                        </Pressable>
                    </View>                           
                </View>
            </View>  
            ...
            <FlatList
                    ...
                    renderItem={({ item }) => (
                        ...
                        <View style={[styles.product, styles.BackgroundWhite,styles.marginTop10, styles.paddingTop10]}>
                            ...
                            <View style={styles.productDescBox}>
                            <Text style={[styles.status , styles.statusColor[item.Status] ]}>{ (item.Status == 1) ? "Paid": "Not Paid" }</Text>                                
                        ...
                        <View style={[styles.productDescBox, styles.MBackgroundGray]}>
                                <Text style={[styles.Datadesc, styles.colorblue]}>Approved Date</Text>
                                <Text style={styles.Datatitle}>{ item.CreatedAt }</Text>                        
                            </View>                 
                            <View style={[styles.productDescBox, styles.MBackgroundGray]}>
                                <Text style={[styles.Datadesc, styles.colorblue]}>A/C Transfer Date</Text>
                                <Text style={styles.Datatitle}>{ item.expectedPD }</Text>                        
                            </View> 
                            <View style={[styles.productDescBox, styles.MBackgroundGray]}>
                                <Text style={[styles.Datadesc, styles.colorblue]}>Work By Friend</Text>
                                <Text style={styles.Datatitle}>{ item.AgentName.split(" ")['0'] }</Text>                        
                            </View>                 
                        </View>
                    </View>                        
                    )}
            ...
            <FlatList
                    ...
                    renderItem={({ item }) => (
                        ...
                        <View style={[styles.product, styles.BackgroundWhite,styles.marginTop10, styles.paddingTop10]}>
                            <View style={[styles.bigWith]}>
                                <Text style={styles.Datatitle}>{ (item.BonusType == "REFERALBONUS") ? "Referal Bonus": "Signup Bonus" } </Text>
                                <Text style={styles.Datadesc}>{ item.fullName }</Text>
                                <Text style={styles.Datadesc}>Lead Id : { item.leadId }</Text>
                            </View>                           
                            <View style={styles.productDescBox}>
                                <Text style={[styles.status , styles.statusColor[item.PaymentStatus] ]}>{ (item.PaymentStatus == 1) ? "Paid": "Not Paid" }</Text>
                                <Text style={styles.LeadId}>Amount : ₹ { item.Amount }/-</Text>
                            </View>                
                        </View> 
                        <View style={[styles.product, styles.BackgroundWhite]}>
                        <View style={[styles.productDescBox, styles.MBackgroundGray]}>
                            ...
                            <View style={[styles.productDescBox, styles.MBackgroundGray]}>
                                <Text style={[styles.Datadesc, styles.colorblue]}>Payment Date</Text>
                                <Text style={styles.Datatitle}>{ item.PaidOn }</Text>                        
                            </View> 
                            <View style={[styles.productDescBox, styles.MBackgroundGray]}>
                                <Text style={[styles.Datadesc, styles.colorblue]}>Work By Friend</Text>
                                <Text style={styles.Datatitle}>{ item.fullName.split(" ")['0'] }</Text>                        
                            </View>                 
                        </View>
                    </View>                        
                    )}
