    ...
    <>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.earningsContainer}>
            ...
            <View style={styles.rowContainer}>
              <View style={{ ...styles.card, borderBottomColor: '#fff', borderBottomWidth: 1 }}>
                ...
                <View>
                  ...
                  <Text style={styles.cardValue}>₹ {parseFloat(uData.PaidEarning) + parseFloat(uData.PaidBonus)}</Text>
                </View>
              </View>
              <View style={{ ...styles.card, borderLeftColor: '#fff', borderLeftWidth: 1, borderBottomColor: '#fff', borderBottomWidth: 1 }}>
                <View style={styles.iconContainer}>
                  <FontAwesome name="rupee" size={18} color="#0d4574" />
                </View>
                <View>
                  <Text style={styles.cardTitle}>Pending Earning</Text>
                  <Text style={styles.cardValue}>₹ {parseFloat(uData.PendingEarning) + parseFloat(uData.UnPaidBonus)}</Text>
                </View>
              </View>
            </View>
            <View style={[styles.rowContainer]}>
              <View style={{ ...styles.card, borderTopColor: '#fff', borderTopWidth: 1 }}>
                <View style={[styles.iconContainer, {
                  right: 18
                }]}>
                  <FontAwesome name="rupee" size={18} color="#0d4574" />
                ...
                <View style={{
                  ...
                  }} style={{ marginLeft: 10, position: 'absolute', right: -15, backgroundColor: '#fff', width: 13, height: 13, borderRadius: 100, alignItems: 'center', justifyContent: 'center' }}>
                    <Text style={{ color: '#0d4574', fontSize: 11, fontWeight: 'bold' }}>i</Text>
                  </TouchableOpacity>
                  <Text style={styles.cardValue}>₹ {uData.SIGNUPBONUS}</Text>
                </View>
              </View>
              <View style={{ ...styles.card, borderLeftColor: '#fff', borderLeftWidth: 1 }}>
                <View style={styles.iconContainer}>
                  <FontAwesome name="rupee" size={18} color="#0d4574" />
                </View>
                <View>
      ...
      >
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }}>
          <Pressable
            style={{ position: 'absolute', flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.5)',width: '100%', height: '100%' }}
            onPress={() => setToolTipVisible('')}
          />
          <View style={{ backgroundColor: '#fff', padding: 20, borderRadius: 10, width: '80%', alignItems: 'center' }}>
            <Text style={{ fontSize: 16, fontWeight: 'bold', marginBottom: 10 }}>{toolTipVisible}</Text>
            <Text style={{ fontSize: 14, textAlign: 'center' }}>
              {toolTipVisible === 'Sign Up Bonus' ? 'Signup bonus will be approved after successful sale of minimum Rs 100 within 60 days. Otherwise Your Bonus Validity Expired.' : 'Referral bonus will be approved after successful sale of minimum Rs 100 within 60 days. Otherwise Your Bonus Validity Expired.'}
            </Text>
          </View>
        </View>
      </Modal>
