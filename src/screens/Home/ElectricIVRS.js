...
const ElectricIVRS = ({ route, navigation }) => {
    const { title } = route.params; 
  const [mobileNo, setMobileNo] = useState('');

  const handleConfirm = () => {
    console.log('Confirm button pressed');
    navigation.navigate('ElectricPayment');
   ...
   <Header title={title || 'Airtel Digital TV'} />     
        ...
        <View style={styles.container} >
            ...
            <View style={styles.card}>
              <Text style={styles.label}>Consumer Number/IVRS ID</Text>
              ...
              <Text style={styles.note}>Please enter your IVRS ID</Text>
            </View>
            </View>
