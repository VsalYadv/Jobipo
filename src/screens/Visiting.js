...
const Visiting = ({ navigation }) => {
  ...
  const shareImage = async () => {
    try {
      ...
      await Share.open({ url: uri, message: 'Hi,                                                               This is from Jobipo Sales Partner' });
    } catch (error) {
      alert(error.message);
    }
  };
        ...
        <View style={styles.card} ref={viewRef}>
          <View style={styles.leftCard}>
            <View style={styles.logo}>
              <Image source={require('../../assets/rect_logo.png')}
                style={{
                  width: 150, height: 50,
                  marginTop: 10
                }}
            ...
            <View style={styles.leftCardBox}>
              ...
              We provide a wide range of campaigns accross multiple categories.
          ...
          <View style={styles.rightCard}>
            ...
            <View style={styles.list}>
              <View style={styles.listItem}>
                ...
                <Text style={styles.listText}>Partner ID : {users.uniqueCode}</Text>
              </View>
              <View style={styles.listItem}>
                <Ionicons name="square-sharp" color="#fff" size={6} />
                <Text style={styles.listText}>Mobile No. : {users.contactNumber1}</Text>
              </View>
              <View style={styles.listItem}>
                <Ionicons name="square-sharp" color="#fff" size={6} />
