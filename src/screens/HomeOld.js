   ...
   const onShare = async () => {
      try {
        const result = await Share.share({
          message:
            'Join Jobipo Now.  Click On Link.                                                                                           Refer Code: ' +users['uniqueCode']+ '                              https://www.jobipo.com/ ',
        });
          ...
          <View style={styles.boxContainer}>
            <View style={styles.flexBoxes}>
              <View style={styles.box}>
                ...
                <View style={styles.currencyText}>
                  ...
                  <Text style={styles.currencyAmount}><FontAwesome name="rupee" size={15} color="#fff" /> {parseFloat(uData.PaidEarning) + parseFloat(uData.PaidBonus)}</Text>
                </View>
              </View>
              ...
              <View style={styles.box}>
                ...
                <View style={styles.currencyText}>
                  <Text style={[styles.currencyType,styles.textone]}>Pending Earning</Text>
                  <Text style={styles.currencyAmount}><FontAwesome name="rupee" size={15} color="#fff" /> {parseFloat(uData.PendingEarning) + parseFloat(uData.UnPaidBonus)}</Text>
                </View>
              </View>
            </View>
            {/* 2nd boxes */}
            <View style={styles.flexBoxes}> 
              <View style={styles.box}>
                ...
                onPress={() => {
                  Alert.alert('Signup Bonus','Signup bonus will be approved after successful sale of minimum Rs 100 within 60 days. Otherwise Your Bonus Validity Expired.');
                }}               
                >
                  <Image
                ...
                <View style={styles.currencyText}>
                  ...
                  <Text style={styles.currencyAmount}><FontAwesome name="rupee" size={15} color="#fff" /> { uData.SIGNUPBONUS }</Text>
                </View>
              </View>
              ...
              <View style={styles.box}>
                <Pressable 
                  style={styles.infoIcon}
                  onPress={() => {
                    Alert.alert('Referral bonus','Referral bonus will be approved after successful sale of minimum Rs 100 within 60 days. Otherwise Your Bonus Validity Expired.');
                  }}                
                  >
                  <Image
                    style={styles.infoImage}
                ...
                <View style={styles.currencyText}>
                  ...
                  <Text style={styles.currencyAmount}><FontAwesome name="rupee" size={15} color="#fff" />  { uData.REFERALBONUS }</Text>
                </View>
              </View>
            </View>
          </View>
